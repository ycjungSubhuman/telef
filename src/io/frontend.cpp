...
namespace telef::io {
    bool FittingSuiteWriterFrontEnd::checkProcessNeeded(FittingSuiteWriterFrontEnd::InputPtrT input) {
        return (saveRGB || saveRawCloud || input->landmark3d->points.size() > 0);
    }

    void FittingSuiteWriterFrontEnd::_process(FittingSuiteWriterFrontEnd::InputPtrT input) {
    ...
    FittingSuiteWriterFrontEnd::FittingSuiteWriterFrontEnd(bool ignoreIncomplete, bool saveRGB, bool saveRawCloud,
