...
int main (int argc, char** argv) {
    ...
    desc.add_options()
            ...
            ("ref,R", po::value<std::string>(), "specify a path of ply file for a PLY mesh model")
            ("shape,S", po::value<std::string>(), "specify a path of text file for a list of PLY mesh models with shape variance")
            ("exp,E", po::value<std::string>(), "specify a path of text file for a list of PLY mesh models with expression variance")
            ("landmark,L", po::value<std::string>(), "specify a path of text file for a list of landmark indices")
            ("shaperank,P", po::value<int>(), "specify the maximum number of shape PCA basis(default 40)")
            ("exprank,X", po::value<int>(), "specify the maximum number of expression PCA basis(default 10)")
    ...
    telef::face::MorphableFaceModel model(fs::path(vm["ref"].as<std::string>()),
                                          shapeSamplePaths, expressionSamplePaths,
