...
namespace telef::face {
    ...
    public:
        ...
        Eigen::VectorXf genPosition(Eigen::VectorXf shapeCoeff, Eigen::VectorXf expressionCoeff);
        ...
        ColorMesh genMesh(Eigen::VectorXf shapeCoeff, Eigen::VectorXf expressionCoeff);
