 ...
 *
 * @param dres_dt_d               de_dt_d[j] = de_dtj. ((number of
 * landmarks)x3x3)-element array
 * @param dres_du_d               de_du_d[j] = de_duj. ((number of
 * landmarks)x3x3)-element array
 * @param dres_da1_d              de_da1_d[j] = de_da1j. ((number of
 * landmarks)x3x(rank of pca model))-element array
 * @param dres_da2_d              de_da2_d[j] = de_da2j. ((number of
 * landmarks)x3x(rank of pca model))-element array
 * @param u_d                   rotation parameter. 3-element array. Axis-angle
 * notation (see cu_quaternion.h)
 * @param model
 * @param point_pair
 */
