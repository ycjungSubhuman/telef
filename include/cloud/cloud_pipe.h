...
namespace telef::cloud {
    ...
    /** Remove NaN Positioned Points from PointCloud */
    class FastBilateralFilterPipe : public Pipe<DeviceCloudConstT, DeviceCloudConstT> {
    private:
        using BaseT = Pipe<DeviceCloudConstT, DeviceCloudConstT>;
        /** standard deviation of the Gaussian used by the bilateral filter for
         * the spatial neighborhood/window. (size of the Gaussian bilateral filter window to use)
         */
        float sigma_s;
         ...
         * (standard deviation of the Gaussian for the depth difference)
         */
        float sigma_r;
